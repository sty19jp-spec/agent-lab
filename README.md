...
## Harness Adoption Pilot

This repository is the Phase9 live pilot target for harness adoption.
Changes are applied only on `chore/adopt-harness-bootstrap`, with workflow snapshots and rollback notes preserved under `reports/adoption/`.
